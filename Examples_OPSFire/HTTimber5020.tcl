...
HTMaterial Timber 2 1 -file TImberPars.dat 5.0 30.0 30.0 350e3;     #Defining HeatTransfer Material with Material tag:2, type tag:1 (any integer);
...
FireModel Idealised 5 -q 60e3 -uniform;    #for fixed heat flux
FireModel UserDefined 6 -file hf5020.dat -type 2; #for heat flux definition using external file (time-heat flux data)
...
HTRecorder -file TimberTdist.out -xloc 0.0 -yloc 0.018 0.042 0.054 0.060;
