...
nDMaterial ElasticIsotropic3DThermal 2 3e10 0.2 0 1.4e-5;
...
nDMaterial PlateRebarThermal 14 9 0;
...
section LayeredShellThermal  3  10  4  0.01  4 0.01 4 0.01 4  0.01  4  0.01 4  0.01  4  0.01  4 0.01 4 0.01  4 0.01 4 0.01;

section LayeredShellThermal  4 -offset $offset 10  4  0.01  4 0.01 4 0.01 4  0.01  4  0.01 4  0.01  4  0.01  4 0.01 4 0.01  4 0.01 4 0.01;
section LayeredShellThermal  5 -offset $offset 10  14  0.01  14 0.01 14 0.01  14 0.01 14 0.01 4  0.01  4 0.01 4 0.01 4  0.01  4  0.01;
section CompositeShellThermal 10 2 0.5 5 0.5;
...
block2D $nx $ny 1 1  ShellNLDKGQThermal 10 { 
    1   0. 0. 0.
    2   3.0 0. 0.
    3  3.0 3.0 0.
    4   0. 3.0 0.
...
recorder Node -file ShellData/DFreeSlabzT.out -time -node [expr ($ny/2)*($nx+1)+$nx/2] -dof 3 disp;
