...
puts "3dhere0";
#nDMaterial PlateFiberThermal 4 12;
set gt [expr 4.0e6/2.2e10*3.7e6*50];
...
#D147
nDMaterial  J2PlaneStressThermal 11 22 2e11 0.3 5.65e8 5.85e8 10 3e8;
...
puts "here0";
#D147Mesh
section LayeredShellThermal   1  13 4  0.008 4  0.008  4 0.008802 3 0.000198 5 0.000198 4 0.004802  4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 ;
section LayeredShellThermal   2  11 4  0.01 4  0.01  4 0.005 4 0.005 4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 4  0.01 ;
#661Mesh
...
#HD12 bars
section LayeredShellThermal   5  13 4  0.01 4  0.01  4 0.005 3 0.000565 5 0.000565 4 0.00387  4  0.01 4  0.01 4  0.01 4  0.01 4  00.01 4  0.01 4  0.01 ;
...
recorder Element -file ShellDataLim147/EleForceSec1Temp.out -time -ele $MidEle   material 1 fiber 1 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec2sigma.out -time -ele $MidEle  material 1 fiber 2 stress;
recorder Element -file ShellDataLim147/EleForceSec2Eps.out -time -ele $MidEle  material 1 fiber 2 strain;
recorder Element -file ShellDataLim147/EleForceSec2Temp.out -time -ele $MidEle   material 1 fiber 2 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec3sigma.out -time -ele $MidEle  material 1 fiber 3 stress;
recorder Element -file ShellDataLim147/EleForceSec3Eps.out -time -ele $MidEle  material 1 fiber 3 strain;
recorder Element -file ShellDataLim147/EleForceSec3Temp.out -time -ele $MidEle   material 1 fiber 3 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec4sigma.out -time -ele $MidEle  material 1 fiber 4 stress;
recorder Element -file ShellDataLim147/EleForceSec4Eps.out -time -ele $MidEle  material 1 fiber 4 strain;
recorder Element -file ShellDataLim147/EleForceSec4Temp.out -time -ele $MidEle   material 1 fiber 4 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec5sigma.out -time -ele $MidEle  material 1 fiber 5 stress;
recorder Element -file ShellDataLim147/EleForceSec5Eps.out -time -ele $MidEle  material 1 fiber 5 strain;
recorder Element -file ShellDataLim147/EleForceSec5Temp.out -time -ele $MidEle   material 1 fiber 5 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec6sigma.out -time -ele $MidEle  material 1 fiber 6 stress;
recorder Element -file ShellDataLim147/EleForceSec6Eps.out -time -ele $MidEle  material 1 fiber 6 strain;
recorder Element -file ShellDataLim147/EleForceSec6Temp.out -time -ele $MidEle   material 1 fiber 6 TempAndElong;


recorder Element -file ShellDataLim147/EleForceSec7sigma.out -time -ele $MidEle  material 1 fiber 7 stress;
recorder Element -file ShellDataLim147/EleForceSec7Eps.out -time -ele $MidEle  material 1 fiber 7 strain;
recorder Element -file ShellDataLim147/EleForceSec7Temp.out -time -ele $MidEle   material 1 fiber 7 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec8sigma.out -time -ele $MidEle  material 1 fiber 8 stress;
recorder Element -file ShellDataLim147/EleForceSec8Eps.out -time -ele $MidEle  material 1 fiber 8 strain;
recorder Element -file ShellDataLim147/EleForceSec8Temp.out -time -ele $MidEle   material 1 fiber 8 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec9sigma.out -time -ele $MidEle  material 1 fiber 9 stress;
recorder Element -file ShellDataLim147/EleForceSec9Eps.out -time -ele $MidEle  material 1 fiber 9 strain;
recorder Element -file ShellDataLim147/EleForceSec9Temp.out -time -ele $MidEle   material 1 fiber 9 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec10sigma.out -time -ele $MidEle  material 1 fiber 10 stress;
recorder Element -file ShellDataLim147/EleForceSec10Eps.out -time -ele $MidEle  material 1 fiber 10 strain;
recorder Element -file ShellDataLim147/EleForceSec10Temp.out -time -ele $MidEle   material 1 fiber 10 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec11sigma.out -time -ele $MidEle  material 1 fiber 11 stress;
recorder Element -file ShellDataLim147/EleForceSec11Eps.out -time -ele $MidEle  material 1 fiber 11 strain;
recorder Element -file ShellDataLim147/EleForceSec11Temp.out -time -ele $MidEle   material 1 fiber 11 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec12sigma.out -time -ele $MidEle  material 1 fiber 12 stress;
recorder Element -file ShellDataLim147/EleForceSec12Eps.out -time -ele $MidEle  material 1 fiber 12 strain;
recorder Element -file ShellDataLim147/EleForceSec12Temp.out -time -ele $MidEle   material 1 fiber 12 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec13sigma.out -time -ele $MidEle  material 1 fiber 13 stress;
recorder Element -file ShellDataLim147/EleForceSec13Eps.out -time -ele $MidEle  material 1 fiber 13 strain;
recorder Element -file ShellDataLim147/EleForceSec13Temp.out -time -ele $MidEle   material 1 fiber 13 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec14sigma.out -time -ele $MidEle  material 1 fiber 14 stress;
recorder Element -file ShellDataLim147/EleForceSec14Eps.out -time -ele $MidEle  material 1 fiber 14 strain;
recorder Element -file ShellDataLim147/EleForceSec14Temp.out -time -ele $MidEle   material 1 fiber 14 TempAndElong;

recorder Element -file ShellDataLim147/EleForceSec15sigma.out -time -ele $MidEle  material 1 fiber 15 stress;
recorder Element -file ShellDataLim147/EleForceSec15Eps.out -time -ele $MidEle  material 1 fiber 15 strain;
recorder Element -file ShellDataLim147/EleForceSec15Temp.out -time -ele $MidEle   material 1 fiber 15 TempAndElong;
