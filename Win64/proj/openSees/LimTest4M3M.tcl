...
recorder Element -file output2/RlayerC2.out -time -ele 2226   material 1 fiber 2 TempAndElong;
recorder Element -file output2/RStressC2.out -time	-ele 2226	material  1	fiber 2	stress;
recorder Element -file output2/RStrainC2.out -time	-ele 2226	material  1	fiber 2	strain;
recorder Element -file output2/RlayerC4.out -time -ele 2226   material 1 fiber 4 TempAndElong;
recorder Element -file output2/RStressC4.out -time -ele 2226   material 1 fiber 4 stress;
recorder Element -file output2/RlayerC10.out -time -ele 2226   material 1 fiber 10 TempAndElong;
recorder Element -file output2/RStressC10.out -time -ele 2226   material 1 fiber 10 stress;
recorder Element -file output2/RlayerC13.out -time -ele 2226   material 1 fiber 13 TempAndElong;
recorder Element -file output2/RStressC13.out -time -ele 2226   material 1 fiber 13 stress;

recorder Element -file output2/CorRlayerC2.out -time -ele 1014   material 1 fiber 2 TempAndElong;
recorder Element -file output2/CorRStressC2.out -time	-ele 1014	material  1	fiber 2	stress;
recorder Element -file output2/CorRlayerC4.out -time -ele 1014   material 1 fiber 4 TempAndElong;
recorder Element -file output2/CorRStressC4.out -time -ele 1014   material 1 fiber 4 stress;
recorder Element -file output2/CorRlayerC10.out -time -ele 1014   material 1 fiber 10 TempAndElong;
recorder Element -file output2/CorRStressC10.out -time -ele 1014   material 1 fiber 10 stress;
recorder Element -file output2/CorRlayerC13.out -time -ele 1014   material 1 fiber 13 TempAndElong;
recorder Element -file output2/CorRStressC13.out -time -ele 1014   material 1 fiber 13 stress;

recorder Element -file output2/EdgRlayerC2.out -time -ele 514   material 1 fiber 2 TempAndElong;
recorder Element -file output2/EdgRStressC2.out -time	-ele 514	material  1	fiber 2	stress;
recorder Element -file output2/EdgRlayerC4.out -time -ele 514   material 1 fiber 4 TempAndElong;
recorder Element -file output2/EdgRStressC4.out -time -ele 514   material 1 fiber 4 stress;
recorder Element -file output2/EdgRlayerC10.out -time -ele 514   material 1 fiber 10 TempAndElong;
recorder Element -file output2/EdgRStressC10.out -time -ele 514   material 1 fiber 10 stress;
recorder Element -file output2/EdgRlayerC13.out -time -ele 514   material 1 fiber 13 TempAndElong;
recorder Element -file output2/EdgRStressC13.out -time -ele 514   material 1 fiber 13 stress;


recorder Element -file output2/RlayerS1.out -time -ele 2226   material 1 fiber 1 TempAndElong;
recorder Element -file output2/RStressS1.out -time	-ele 2226	material  1	fiber 1	stress;
recorder Element -file output2/RStrainS1.out -time	-ele 2226	material  1	fiber 1	strain;
recorder Element -file output2/RlayerS2.out -time -ele 2226   material 1 fiber 3 TempAndElong;
recorder Element -file output2/RStressS2.out -time -ele 2226   material 1 fiber 3 stress;
recorder Element -file output2/RStrainS2.out -time -ele 2226   material 1 fiber 3 strain;
recorder Element -file output2/RlayerS3.out -time -ele 2226   material 1 fiber 5 TempAndElong;
recorder Element -file output2/RStressS3.out -time -ele 2226   material 1 fiber 5 stress;
recorder Element -file output2/RStrainS3.out -time -ele 2226   material 1 fiber 5 strain;
recorder Element -file output2/RlayerS4.out -time -ele 2226   material 1 fiber 7 TempAndElong;
recorder Element -file output2/RStressS4.out -time -ele 2226   material 1 fiber 7 stress;
recorder Element -file output2/RStrainS4.out -time -ele 2226   material 1 fiber 7 strain;
recorder Element -file output2/RlayerS5.out -time -ele 2226   material 1 fiber 9 TempAndElong;
recorder Element -file output2/RStressS5.out -time -ele 2226   material 1 fiber 9 stress;
recorder Element -file output2/RStrainS5.out -time -ele 2226   material 1 fiber 9 strain;
recorder Element -file output2/RlayerRV.out -time -ele 2226   material 1 fiber 14 TempAndElong;
recorder Element -file output2/RStressRV.out -time -ele 2226   material 1 fiber 14 stress;
recorder Element -file output2/RlayerRL.out -time -ele 2226   material 1 fiber 15 TempAndElong;
recorder Element -file output2/RStressRL.out -time -ele 2226   material 1 fiber 15 stress;

recorder Element -file output2/FlayerS1.out -time -ele 2526   material 1 fiber 1 TempAndElong;
recorder Element -file output2/FStressS1.out -time	-ele 2526	material  1	fiber 1	stress;
recorder Element -file output2/FlayerC2.out -time -ele 2526   material 1 fiber 2 TempAndElong;
recorder Element -file output2/FStressC2.out	-time	-ele 2526	material  1	fiber 2	stress;
recorder Element -file output2/FStrainC2.out	-time	-ele 2526	material  1	fiber 2	strain;
recorder Element -file output2/FlayerRV.out -time -ele 2526   material 1 fiber 4 TempAndElong;
recorder Element -file output2/FlayerRL.out -time -ele 2526   material 1 fiber 5 TempAndElong;
...
pattern Plain 2 Linear {
   ...
   for {set i 1} {$i <= $nx} {incr i 1} {
	...
	#eleLoad  -ele [expr int($j*100+$i)]  -type -shellThermal -source "130.dat"        -0.0925    0.0375
	} elseif {$sec=="flat"} { 
    #eleLoad -ele        $eleTag	     -type -shellThermal -source    "fileName"           $Y1     $Y2
