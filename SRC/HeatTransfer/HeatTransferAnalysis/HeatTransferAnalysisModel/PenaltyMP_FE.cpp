...
PenaltyMP_FE::PenaltyMP_FE(int tag, HeatTransferDomain &theDomain, 
			   MP_TemperatureBC &TheMP, double Alpha)
:HT_FE_Element(tag, 1,2),
...
const Matrix &
PenaltyMP_FE::getTangent(HeatTransferIntegrator *theNewIntegrator)
{
...
const Vector &
PenaltyMP_FE::getResidual(HeatTransferIntegrator *theNewIntegrator)
{
    // zero residual, CD = 0
    return *resid;
}
