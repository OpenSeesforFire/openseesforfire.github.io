...
// This class is a modified version of CTestNormUnbalance 
...
#ifndef CTestNormResidual_h
#define CTestNormResidual_h
...
class CTestNormResidual: public HT_ConvergenceTest
{
  public:
	  // constructors
	  CTestNormResidual();	    	
	  CTestNormResidual(double tol, int maxNumIter, int printFlag, int normType = 2);
