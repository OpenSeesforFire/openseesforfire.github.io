...
//
// This class implements the thermal properties of normal weight concrete as 
// given EC 2

#ifndef NWConcreteEC2_h
#define NWConcreteEC2_h

#include <HeatTransferMaterial.h>

class NWConcreteEC2: public HeatTransferMaterial
{
    public:
		NWConcreteEC2(int tag, double moisture);    
