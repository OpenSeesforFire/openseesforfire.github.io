...
//
// This class implements the thermal properties of light weight concrete
// as given in EC 4

#ifndef LWConcreteEC4_h
#define LWConcreteEC4_h

#include <HeatTransferMaterial.h>

class LWConcreteEC4: public HeatTransferMaterial
{
    public:
		LWConcreteEC4(int tag, double moisture);    
		virtual ~LWConcreteEC4();
