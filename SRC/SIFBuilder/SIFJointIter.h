...
// Revision: A
//
// Description: This file contains the class definition for Simple_JointIter.
...
#ifndef SIFJointIter_h
#define SIFJointIter_h
...
{
  public:
    SIFJointIter(TaggedObjectStorage *theStorage);
    virtual ~SIFJointIter();

    virtual SIFJoint *operator()(void);
