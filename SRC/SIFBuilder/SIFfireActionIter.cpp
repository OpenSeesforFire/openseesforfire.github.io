...
SIFfireActionIter::SIFfireActionIter(TaggedObjectStorage *theStorage)
  :myIter(theStorage->getComponents())
{
}


SIFfireActionIter::~SIFfireActionIter()
{
}    

void
SIFfireActionIter::reset(void)
{
    myIter.reset();
}    
...
SIFfireAction*
SIFfireActionIter::operator()(void)
{
	...
	SIFfireAction* result = (SIFfireAction *)theComponent;
	return result;
    }
}
