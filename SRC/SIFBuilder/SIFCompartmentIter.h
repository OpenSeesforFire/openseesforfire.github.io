...
#ifndef SIFCompartmentIter_h
#define SIFCompartmentIter_h
...
{
  public:
    SIFCompartmentIter(TaggedObjectStorage *theStorage);
    virtual ~SIFCompartmentIter();

    virtual SIFCompartment *operator()(void);
