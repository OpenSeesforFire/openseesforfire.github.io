...
#ifndef SIFfireActionIter_h
#define SIFfireActionIter_h
...
{
  public:
    SIFfireActionIter(TaggedObjectStorage *theStorage);
    virtual ~SIFfireActionIter();

    virtual SIFfireAction *operator()(void);
