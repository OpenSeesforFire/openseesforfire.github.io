...
SIFYBeamIter::SIFYBeamIter(TaggedObjectStorage *theStorage)
  :myIter(theStorage->getComponents())
{
}


SIFYBeamIter::~SIFYBeamIter()
{
}    

void
SIFYBeamIter::reset(void)
{
    myIter.reset();
}    
...
SIFYBeamIter::operator()(void)
{
	...
	SIFYBeam* result = (SIFYBeam *)theComponent;
	return result;
    }
}
