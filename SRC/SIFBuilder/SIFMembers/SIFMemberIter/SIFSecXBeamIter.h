...
#ifndef SIFSecXBeamIter_h
#define SIFSecXBeamIter_h
...
{
  public:
    SIFSecXBeamIter(TaggedObjectStorage *theStorage);
    virtual ~SIFSecXBeamIter();

    virtual SIFXBeamSec *operator()(void);
