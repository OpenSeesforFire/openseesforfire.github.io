...
SIFSlabIter::SIFSlabIter(TaggedObjectStorage *theStorage)
  :myIter(theStorage->getComponents())
{
}


SIFSlabIter::~SIFSlabIter()
{
}    

void
SIFSlabIter::reset(void)
{
    myIter.reset();
}    
...
SIFSlabIter::operator()(void)
{
	...
	SIFSlab* result = (SIFSlab *)theComponent;
	return result;
    }
}
