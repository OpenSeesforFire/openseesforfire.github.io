...
SIFXBeamIter::SIFXBeamIter(TaggedObjectStorage *theStorage)
  :myIter(theStorage->getComponents())
{
}


SIFXBeamIter::~SIFXBeamIter()
{
}    

void
SIFXBeamIter::reset(void)
{
    myIter.reset();
}    
...
SIFXBeamIter::operator()(void)
{
	...
	SIFXBeam* result = (SIFXBeam *)theComponent;
	return result;
    }
}
