...
#ifndef DruckerPragerSteelThermal_h
#define DruckerPragerSteelThermal_h

// $Revision: 1.1 $
// $Date: 2010-02-04 00:44:04 $
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/DruckerPragerSteelThermal.h,v $
                                                                      
// Written: Kathryn Petek, Peter Mackenzie-Helnwein, and Pedro Arduino
// Created: 12/04
//
// Description: This file contains the class definition for DruckerPragerSteelThermal. 
//
...
class DruckerPragerSteelThermal : public NDMaterial
{
  public:
    // Full Constructor
    DruckerPragerSteelThermal(int tag, int classTag, double bulk, double shear,
  ...
  // Elastic Constructor
  //	  DruckerPragerSteelThermal(int tag, double bulk, double shear);
