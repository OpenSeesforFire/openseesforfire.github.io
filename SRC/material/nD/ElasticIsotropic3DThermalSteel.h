...
#ifndef ElasticIsotropic3DThermalSteel_h
#define ElasticIsotropic3DThermalSteel_h
	 
#include <ElasticIsotropicMaterial.h>

class ElasticIsotropic3DThermalSteel : public ElasticIsotropicMaterial
{
  public:
    ElasticIsotropic3DThermalSteel (int tag, double E, double nu, double rho);
    ElasticIsotropic3DThermalSteel ();
    ~ElasticIsotropic3DThermalSteel ();

    const char *getClassType(void) const {return "ElasticIsotropic3DThermalSteel";};
