...
#ifndef CDPPlaneStressThermal_h
#define CDPPlaneStressThermal_h
...
class CDPPlaneStressThermal : public NDMaterial
{
  public:
  CDPPlaneStressThermal(int tag, 
				   double E, 
				   double nu, 
				   double ft,
				   double fc, 
  ...
  void StrsPr(const Vector&sig, double &fi, double &sigPr1, double &sigPr2, double &strsMises);
  //void StrsInvar(const Vector&sig, double strsI1, double strsJ2);
