...
#ifndef CapPlasticityThermal_h
#define CapPlasticityThermal_h
...
class CapPlasticityThermal : public NDMaterial {
 ...
 public :
  ...
  CapPlasticityThermal( const CapPlasticityThermal & a);
  
  ~CapPlasticityThermal( ) ;
