...
FiberSection2dThermal::FiberSection2dThermal() :
    ...
    yBar(0.0), sectionIntegr(0), e(2), eCommit(2), s(0), ks(0), dedh(2), AverageTemperature(0.0)//, theTemperatures(0),theTemperatureFactor(0)
{
    s = new Vector(sData, 2);
    ks = new Matrix(kData, 2, 2);
...
double
FiberSection2dThermal::getTemperature(void)
{
