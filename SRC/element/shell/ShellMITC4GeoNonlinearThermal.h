...
// $Source: /usr/local/cvs/OpenSees/SRC/element/shell/ShellMITC4GeoNonlinearThermal.h,v $
...
class ShellMITC4GeoNonlinearThermal : public Element {

 public:
  
  //null constructor
  ShellMITC4GeoNonlinearThermal();
  
  //full constructor
  ShellMITC4GeoNonlinearThermal(int tag, 
	     int node1,
	     int node2,
	     int node3,
	     int node4,
  ...
  //destructor 
  virtual ~ShellMITC4GeoNonlinearThermal( ) ;

  //set domain because frank is a dumb ass 
  void setDomain( Domain *theDomain ) ;
  
  int update(void);//J.Jiang add to update
  ...
  private : 
    ...
    static Matrix stiff ;
    static Vector resid ;
	//static Vector residThermal ;//J.Jiang
    static Matrix mass ;
	...
	double residThermal[24];//J.Jiang
} ; 
