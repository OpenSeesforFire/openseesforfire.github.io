...
// $Source: /usr/local/cvs/OpenSees/SRC/element/shell/ShellMITC4GNLThermal.h,v $
...
class ShellMITC4GNLThermal : public Element {

 public:
  
  //null constructor
  ShellMITC4GNLThermal();
  
  //full constructor
  ShellMITC4GNLThermal(int tag, 
	     int node1,
	     int node2,
	     int node3,
	     int node4,
