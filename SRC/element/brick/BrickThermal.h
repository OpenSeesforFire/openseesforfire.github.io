...
// $Source: /usr/local/cvs/OpenSees/SRC/element/BrickThermal/BrickThermal.h,v $
...
#ifndef BRICKTHERMAL_H
#define BRICKTHERMAL_H
...
class BrickThermal : public Element {
  ...
  public :
    ...
    //destructor 
    virtual ~BrickThermal( ) ;

    const char *getClassType(void) const {return "BrickThermal";};
