...
#ifndef DispBeamColumn2dThermalAI2_h
#define DispBeamColumn2dThermalAI2_h
...
class DispBeamColumn2dThermalAI2 : public Element
{
public:
    DispBeamColumn2dThermalAI2(int tag, int nd1, int nd2,
        int numSections, SectionForceDeformation** s,
        BeamIntegration& bi, CrdTransf& coordTransf, const char* path,
        double rho = 0.0);
    DispBeamColumn2dThermalAI2();
    ~DispBeamColumn2dThermalAI2();

    const char* getClassType(void) const { return "DispBeamColumn2dThermalAI2"; };
    int eleTag;
...
private:
    ...
    double disp;
    double temp;
    double getPredictedStiffness(int eleTag, double Temp, double disp);
    double getPredictedForce(int eleTag, double Temp, double disp);
};
