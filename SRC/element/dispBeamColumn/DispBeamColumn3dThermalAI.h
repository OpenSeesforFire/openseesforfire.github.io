...
// $Source: /usr/local/cvs/OpenSees/SRC/element/dispBeamColumn/DispBeamColumn3dThermalAIAI.h,v $

// Written: MHS
// Created: Feb 2001
//
// Description: This file contains the class definition for DispBeamColumn3dThermalAIAI.
// The element displacement field gives rise to constant axial strain,
// linear curvature, and constant twist angle.

#ifndef DispBeamColumn3dThermalAI_h
#define DispBeamColumn3dThermalAI_h
...
class DispBeamColumn3dThermalAI : public Element
{
public:
    DispBeamColumn3dThermalAI(int tag, int nd1, int nd2,
        int numSections, SectionForceDeformation** s,
        BeamIntegration& bi,
        CrdTransf& coordTransf, double rho = 0.0);
    DispBeamColumn3dThermalAI();
    ~DispBeamColumn3dThermalAI();

    const char* getClassType(void) const { return "DispBeamColumn3dThermalAI"; };
    int eleTag;
...
private:
    ...
    double deflection;
    double Temperature;
    double getPredictedStiffness(double Temperature, double deflection);//int eleTag, 
    double getPredictedForce(double Temperature, double deflection);//int eleTag, 
