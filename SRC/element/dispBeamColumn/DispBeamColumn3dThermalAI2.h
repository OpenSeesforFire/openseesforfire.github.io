...
// $Source: /usr/local/cvs/OpenSees/SRC/element/dispBeamColumn/DispBeamColumn3dThermalAI2.h,v $
...
#ifndef DispBeamColumn3dThermalAI2_h
#define DispBeamColumn3dThermalAI2_h
...
class DispBeamColumn3dThermalAI2 : public Element
{
public:
    DispBeamColumn3dThermalAI2(int tag, int nd1, int nd2,
        int numSections, SectionForceDeformation** s,
        BeamIntegration& bi,
        CrdTransf& coordTransf, double rho = 0.0);
    DispBeamColumn3dThermalAI2();
    ~DispBeamColumn3dThermalAI2();

    const char* getClassType(void) const { return "DispBeamColumn3dThermalAI2"; };
    int eleTag;
...
private:
    ...
    double deflection;
    double Temperature;
    double getPredictedStiffness(int eleTag, double Temperature, double deflection);//
    double getPredictedForce(int eleTag, double Temperature, double deflection);
    double store(int eleTag, double Temperature, double deflection, double RP);// WEIJI
};
