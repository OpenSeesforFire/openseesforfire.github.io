...
// $Source: /usr/local/cvs/OpenSees/SRC/element/dispBeamColumn/DispBeamColumn2dThermalNUT.h,v $
...
#ifndef DispBeamColumn2dThermalNUT_h
#define DispBeamColumn2dThermalNUT_h
...
class DispBeamColumn2dThermalNUT : public Element
{
  public:
    DispBeamColumn2dThermalNUT(int tag, int nd1, int nd2,
		     int numSections, SectionForceDeformation **s,
		     BeamIntegration &bi, CrdTransf &coordTransf,
		     double rho = 0.0);
    DispBeamColumn2dThermalNUT();
    ~DispBeamColumn2dThermalNUT();

    const char *getClassType(void) const {return "DispBeamColumn2dThermalNUT";};
