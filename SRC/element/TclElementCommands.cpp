...
extern void *OPS_NewShellMITC4Thermal(void);//uoe
extern void *OPS_NewShellMITC4GNLThermal(void);//uoe
extern void *OPS_NewShellNLDKGQThermal(void);//uoe
extern void *OPS_NewShellNLDKGQ(void);//uoe
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  if ((strcmp(argv[1],"truss") == 0) || (strcmp(argv[1],"Truss") == 0)) {
  ...
  else if ((strcmp(argv[1],"ShellMITC4GNLThermal") == 0) ||(strcmp(argv[1],"ShellMITC4GNLThermal") == 0)) {
    
    void *theEle = OPS_NewShellMITC4GNLThermal();
    if (theEle != 0) 
      theElement = (Element *)theEle;
    else {
      opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
    ...
    void *theEle = OPS_NewShellNLDKGQThermal();
    if (theEle != 0) 
      theElement = (Element *)theEle;
    else {
      opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
  ...
  } else if (strcmp(argv[1],"elasticBeamColumn") == 0||(strcmp(argv[1],"elasticBeamColumnBuck") == 0)) {
    int eleArgStart = 1;
  ...
  */
    ...
    return result;
		 ...
		 strcmp(argv[1],"dispBeamColumnThermalNUT") == 0  || 
